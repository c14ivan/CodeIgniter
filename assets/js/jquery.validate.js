...
*/ (function($) {
    ...
    $.extend($.fn, {
        ...
        rules: function(command, argument) {
            ...
            if (command) {
                var settings = $.data(element.form, "validator")
                    .settings;
    ...
    $.extend($.validator, {
            ...
            onfocusin: function(element, event) {
                ...
                if (this.settings.focusCleanup && !this.blockFocusCleanup) {
                    if (this.settings.unhighlight) {
                        this.settings.unhighlight.call(this, element, this.settings.elErrorClass, this.settings.validClass);
                    }
        ...
        prototype: {
            ...
            init: function() {
                ...
                $(this.currentForm)
                    .validateDelegate(":text, [type='password'], [type='file'], select, textarea, " + "[type='number'], [type='search'] ,[type='tel'], [type='url'], " + "[type='email'], [type='datetime'], [type='date'], [type='month'], " + "[type='week'], [type='time'], [type='datetime-local'], " + "[type='range'], [type='color'] ", "focusin focusout keyup", delegate)
            ...
            resetForm: function() {
                ...
                this.hideErrors();
                this.elements()
                    .removeClass(this.settings.elErrorClass)
            ...
            hideErrors: function() {
                this.addWrapper(this.toHide).fadeOut(600,function(){$(this).hide()});
            },
            ...
            elements: function() {
                ...
                return $(this.currentForm)
                    ...
                    if (this.name in rulesCache || !validator.objectLength($(this)
                        .rules())) {
                        return false;
                    }
            ...
            customDataMessage: function(element, method) {
                return $(element)
                    .data("msg-" + method.toLowerCase()) || (element.attributes && $(element)
                    .attr("data-msg-" + method.toLowerCase()));
            },
            ...
            defaultShowErrors: function() {
                ...
                for (i = 0; this.errorList[i]; i++) {
                    ...
                    if (this.settings.highlight) {
                        this.settings.highlight.call(this, error.element, this.settings.elErrorClass, this.settings.validClass);
                    }
                ...
                if (this.settings.unhighlight) {
                    for (i = 0, elements = this.validElements(); elements[i]; i++) {
                        this.settings.unhighlight.call(this, elements[i], this.settings.elErrorClass, this.settings.validClass);
                    }
                }
            ...
            showLabel: function(element, message) {
                ...
                if (label.length) {
                    ...
                    if (!this.labelContainer.append(label)
                        .length) {
        ...
        normalizeRules: function(rules, element) {
            ...
            $.each(rules, function(prop, val) {
                ...
                if (val.param || val.depends) {
                    ...
                    case "string":
                        keepRule = !! $(val.depends, element.form)
                            .length;
                        break;
                    case "function":
...
(function($) {
    ...
    $.validator.addMethod("phone", function(phone_number, element) {
        ...
        var minDigitsInIPhoneNumber = ($(element).rules().minlength)?$(element).rules().minlength:7;

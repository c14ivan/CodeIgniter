...
$config['permission']['capabilities']=array(
        ...
        'enrolments/manage'=>array('weight'=>30,'ctx_level'=>CONTEXT_HOME,'parent'=>'enrolment_menu','visible'=>true,'position'=>'left-bar','roles'=>'super'),
        'enrolments/asigns'=>array('weight'=>30,'ctx_level'=>CONTEXT_HOME,'parent'=>'enrolment_menu','visible'=>true,'position'=>'left-bar','roles'=>'super,admin'),
        );